...
<head>
    ...
    <style>
        ...
        .modern-alert-button {
            background: linear-gradient(135deg, #F6741C, #e55a1b) !important;
            border: none !important;
            ...
            box-shadow: 0 4px 15px rgba(246, 116, 28, 0.3) !important;
        }

        .modern-alert-button:hover {
            transform: translateY(-2px) !important;
            box-shadow: 0 6px 20px rgba(246, 116, 28, 0.4) !important;
            background: linear-gradient(135deg, #e55a1b, #d4521a) !important;
        }

        .modern-alert-button:focus {
            box-shadow: 0 0 0 3px rgba(246, 116, 28, 0.2) !important;
        }

        .modern-alert-button-error {
        ...
        .modern-alert-button-error:hover {
            transform: translateY(-2px) !important;
            box-shadow: 0 6px 20px rgba(231, 76, 60, 0.4) !important;
            background: linear-gradient(135deg, #c0392b, #a93226) !important;
        }

        .modern-alert-button-error:focus {
        ...
        $(document).ready(function() {
            ...
            $("#butao").on("click", function() {
                ...
                if (cpf === "") {
                    Swal.fire({
                        html: `
                            <div style="padding: 30px 20px; text-align: center; font-family: 'Montserrat', sans-serif;">
                                <div style="
                                    width: 80px; 
                                    height: 80px; 
                                    margin: 0 auto 20px; 
                                ...
                                <p style="
                                    ...
                                    font-weight: 400;
                                ">
                                    Por favor, preencha seu <strong style="color: #e74c3c;">CPF</strong> para continuar.<br>
                                    Este campo é necessário para acessar seu quadro de horários.
                                </p>
                                ...
                                ">
                                    <div style="
                                        ...
                                        justify-content: center;
                                    ">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#f39c12" style="margin-right: 8px;">
                        ...
                        customClass: {
                            ...
                            confirmButton: 'modern-alert-button-error'
                        },
                                    ...
                                    <div style="padding: 30px 20px; text-align: center; font-family: 'Montserrat', sans-serif;">
                                        ...
                                        ">
                                            ...
                                            <span style="
                                                ...
                                                font-weight: 500;
                                            ">
                                                Horário de atendimento: Segunda a Sexta, 8h às 21h
                                            </span>
                                        </div>
                                    </div>
                                `,
                                confirmButtonText: 'Entendi',
                                confirmButtonColor: '#F6741C',
                                customClass: {
                                    popup: 'modern-alert-popup',
